...
## Installation
Install by searching for *swarm* in the module browsing tool or manually using this url: https://github.com/averagejoe77/swarm/releases/latest/download/module.json
